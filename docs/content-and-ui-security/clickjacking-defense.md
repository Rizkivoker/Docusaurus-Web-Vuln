...
## Introduction to Clickjacking Defense
...
The `SameSite` cookie attribute defined in [RFC 6265bis](https://tools.ietf.org/html/draft-ietf-httpbis-rfc6265bis-02#section-5.3.7) is primarily intended to defend against **cross-site request forgery (CSRF)**; however it can also provide protection against Clickjacking attacks.
